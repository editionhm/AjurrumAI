...
if st.session_state.user["connected"]:
    ...
    if prompt := st.chat_input("Write your text here | اكتب نصك هنا"):
        ...
        user_prompt = f"{context} The user asked: {prompt}. Remember, you are an Arabic Grammar teacher. Explain the best as possible with examples in arabic. The main language that you should write on is {language}"
